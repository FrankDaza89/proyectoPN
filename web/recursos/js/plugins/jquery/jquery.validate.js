		...
		maxlength: function( value, element, param ) {
			...
			return this.optional( element ) || length <= param;
                ...
                validPassword: function(value) {
                    var passReg = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}$";
                    var resp = value.match(new RegExp(passReg));
                    return resp;
                },
                isEmail: function(value) {
                    ...
                    var resp;
                    if (value !== '') {
                        resp = value.match(new RegExp(emailReg));
                    } else {
                        resp = true;
                    }
                    return resp;
                ...
                cedulaValida: function(value) {
                    var numProvicias = 24;
                    var prov = parseInt(value.substring(0, 2));
                    if (!((prov > 0) && (prov <= numProvicias))) {
                        return false;
                    }
                    array = value.split("");
                    num = array.length;                   
